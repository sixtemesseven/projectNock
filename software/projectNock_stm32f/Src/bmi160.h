 ...
 */
typedef enum {
	BMI160_TAP_SHOCK_DURATION_50MS = 0, BMI160_TAP_SHOCK_DURATION_75MS,
 ...
 */
typedef enum {
	BMI160_TAP_QUIET_DURATION_30MS = 0, BMI160_TAP_QUIET_DURATION_20MS,
...
class BMI160
{
	public:
		...
		void getReadableDataBMI160(int32_t* data);									//Returns pointer to uint16_t array with accel and gyro in all three axes
